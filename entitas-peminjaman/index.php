              ...
              <table class="table table-bordered" id="myTable">
                <thead>
                  ...
                  <th scope="col">NO</th>
                    ...
                    <th scope="col">TAGGAL_PEMINJAMAN</th>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit-buku.php?id=<?php echo $row['id_peminjaman'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus-buku.php?id=<?php echo $row['id_peminjaman'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                         </td>
                  </tr>
